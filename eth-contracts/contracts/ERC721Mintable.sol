...
contract Ownable {
    /* This contract was simply copy pasted from the openzeppelin implementation. This implementation already contains
...
//    @dev Approves another address to transfer the given token ID
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "The address provided is invalid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Receiver address is not valid");
        // TODO: update token counts & transfer ownership of the token ID
        require(ownerOf(tokenId) == from, "Sender is not token owner");
...
/*
The following contract is a subclass of an `ERC721Metadata` contract instantiated with specific attributes. I decided
to call my token `test` with symbol `TST`
*/
